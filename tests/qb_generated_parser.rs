...
use llrm::frontend::qb::generated_parser::parse_vertical_slice;
use llrm::frontend::qb::{Dialect, Module, source};
...
fn golden_root() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR")).join("frontends/qb/fixtures/legacy_ast_goldens")
}
...
fn checked_in_legacy_ast_goldens_cover_the_accepted_compat_cases() {
    let root = Path::new(env!("CARGO_MANIFEST_DIR")).join("frontends/qb/compat");
