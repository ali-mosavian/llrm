...
of llrm, built from agents.md's own measured semantics ("What the runtime
...
A second finding was BC's own, not the evaluator's or llrm's: `IF <expr>
...
one, as a BC behavior to know about rather than a llrm bug.
...
the program before it ever reaches a llrm comparison -- so this shrinks
