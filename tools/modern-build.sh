...
# llrm-modern compiles the program and runtime/modern/runtime.mod, jwasm
...
"$bin/llrm-modern" "$source" -o "$work/program.obj" "$level" --procedure-segments >/dev/null
...
"$bin/llrm-modern" "$root/runtime/modern/runtime.mod" -o "$work/runtime.obj" "$level" --procedure-segments $used >/dev/null
