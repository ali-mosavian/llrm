...
class Operation(StrEnum):
    ...
    # Two registers shifted as one number with `shld` or `shrd`; sources[0]
    # IS dests[0], sources[1] supplies the incoming bits, and sources[2] is
    # an immediate or cl. Nothing except the count is fixed.
    FUNNEL = "funnel"
