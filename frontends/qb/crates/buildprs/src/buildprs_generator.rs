...
mod tests {
    ...
    fn fixture_bridge_decodes_default_mode_runtime_tables_from_prsstate() {
        ...
        let default_mode = generate_tables_from_prsstate(
            include_str!("../../../fixtures/buildprs/qbasic-1.1-o0/prsstate.asm"),
            &opcodes,
        )
    ...
    fn default_mode_artifacts_satisfy_buildprs_contract() {
        let artifacts = ArtifactSet::new(
            include_str!("../../../fixtures/buildprs/qbasic-1.1-o0/prstab.inc"),
            include_str!("../../../fixtures/buildprs/qbasic-1.1-o0/prsirw.inc"),
            include_str!("../../../fixtures/buildprs/qbasic-1.1-o0/prsstate.asm"),
            include_str!("../../../fixtures/buildprs/qbasic-1.1-o0/prsrwt.asm"),
        )
        .validate()
...
"#,
    ...
    fn reserved_word_tables_match_golden_with_scaffold_lowering() {
        ...
        buildprs_tokens::validate_rw_tables_against_golden(
            &tables,
            include_str!("../../../fixtures/buildprs/qbasic-1.1/prsorw.inc"),
            prsrwt,
            &codec,
        )
