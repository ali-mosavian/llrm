...
; This file was created by program 'buildprs' on Sat Jun 13 15:58:51 2026
...
tState  LABEL   BYTE
        DB      0eH             , 011H          ; 0:  tkSHARED->19
        DB      03H                             ; 2:  EMIT(opStCommon)
        DW      opStCommon                      
        DB      05H             , 01H           ; 5:  EMITFFFF->8
        DB      01H                             ; 7:  Reject
        DB      0aH             , 03H           ; 8:  tkDiv->13
        DB      05H             , 01eH          ; 10:  EMITFFFF->42
        DB      01H                             ; 12:  Reject
        DB      09H             , 01H           ; 13:  IdNamCom->16
        DB      01H                             ; 15:  Reject
        DB      0aH             , 018H          ; 16:  tkDiv->42
        DB      01H                             ; 18:  Reject
        ...
        DB      01H                             ; 27:  Reject
        DB      0aH             , 03H           ; 28:  tkDiv->33
        DB      05H             , 07H           ; 30:  EMITFFFF->39
        DB      01H                             ; 32:  Reject
        DB      09H             , 01H           ; 33:  IdNamCom->36
        DB      01H                             ; 35:  Reject
        DB      0aH             , 01H           ; 36:  tkDiv->39
        DB      01H                             ; 38:  Reject
        DB      07H             , 01H           ; 39:  ACTIONidShared->42
        DB      01H                             ; 41:  Reject
        DB      06H             , 01H           ; 42:  ACTIONidCommon->45
        DB      01H                             ; 44:  Reject
        DB      08H             , 01H           ; 45:  IdAryI->48
        DB      01H                             ; 47:  Reject
        DB      0bH             , 0dbH          ; 48:  tkComma->45
        DB      00H                             ; 50:  Accept

        DB      08H             , 01H           ; 51:  IdAryI->54
        DB      01H                             ; 53:  Reject
        DB      03H                             ; 54:  EMIT(opFnAbs)
        DW      opFnAbs                         
        DB      00H                             ; 57:  Accept

        DB      03H                             ; 58:  EMIT(UNDEFINED)
        DW      UNDEFINED                       
        DB      00H                             ; 61:  Accept

; state table = 62 bytes
