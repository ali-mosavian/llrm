...
pub fn rewound(body: &Rc<MirBody>, registers: i64, costs: Option<&OperationCosts>) -> Rc<MirBody> {
    let default_costs;
...
pub fn simplified(body: &Rc<MirBody>) -> Result<Rc<MirBody>, SubstitutionError> {
    let facts = consts::known(body, None, None, None, None);
