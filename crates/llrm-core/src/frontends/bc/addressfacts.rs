...
impl Region {
    pub fn shifted(&self, delta: &Interval) -> Option<Region> {
    ...
    pub fn overlaps(&self, width: u32, other: impl Into<Region>, size: u32) -> bool {
...
pub fn region(anchor: Addr, offset: Interval, width: i64) -> Option<Region> {
