...
pub fn computed(at: i64, kind: Kind, result: Value, args: Vec<Arg>, width: u32) -> Op {
    let loads = args
        .iter()
...
impl AllocationHints {
    ...
    pub fn from_body(body: &RaisedBody) -> Result<Self, AllocationHintsError> {
...
pub fn with_live_outs(body: RaisedBody) -> RaisedBody {
...
pub fn public(body: RaisedBody) -> MirBody {
    body.body
}
...
pub fn frame_bounded(body: MirBody, pointers: bool) -> MirBody {
...
pub fn _copied_word<D: std::borrow::Borrow<Op>>(arg: &Arg, definitions: &BTreeMap<Value, D>) -> Arg {
...
pub fn extracted_whole<D: std::borrow::Borrow<Op>>(high: &Arg, low: &Arg, definitions: &BTreeMap<Value, D>) -> Option<Held> {
