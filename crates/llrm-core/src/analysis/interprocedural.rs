...
pub type Returns = IndexMap<String, Vec<Const>>;
pub type Parameters = IndexMap<String, Vec<Option<Const>>>;
...
pub fn current_parameter_constants(
...
pub fn specialize_parameters(body: &Rc<MirBody>, parameters: &[MemRef], constants: &[Option<Const>]) -> Rc<MirBody> {
...
pub fn constant_returns(bodies: &IndexMap<String, Rc<MirBody>>) -> Returns {
...
pub fn pure_procedures(procedures: &IndexMap<String, (&MirBody, &IndexMap<i64, String>)>) -> BTreeSet<String> {
...
pub fn terminal_calls(body: &Rc<MirBody>, calls: &IndexMap<i64, String>, noreturn: &BTreeSet<String>) -> Rc<MirBody> {
    control::after_terminal_calls(body, &terminal_sites(calls, noreturn))
}

/// Direct call sites whose named callee cannot return.
pub fn terminal_sites(calls: &IndexMap<i64, String>, noreturn: &BTreeSet<String>) -> BTreeSet<i64> {
...
pub fn argument_sites(body: &MirBody, contracts: &IndexMap<i64, Contract>) -> IndexMap<i64, BTreeSet<i64>> {
    let mut out = IndexMap::default();
    for block in &body.blocks {
