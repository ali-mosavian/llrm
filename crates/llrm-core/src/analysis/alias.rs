...
pub fn nonnull_by_definition(body: &MirBody, defining: Option<&Op>, value: Value) -> Option<bool> {
...
pub fn may_point(body: &MirBody) -> HashSet<Value> {
...
pub fn pointers(body: &Rc<MirBody>) -> Result<Rc<PointsTo>, String> {
