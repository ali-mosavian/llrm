...
pub fn evaluated(kind: Kind, rule: &Semantics, inputs: &[Finite]) -> Option<Finite> {
...
pub fn loop_exits(body: &Rc<MirBody>, dgroup: &BTreeSet<i64>, calls: &IndexMap<i64, String>) -> Vec<LoopExit> {
