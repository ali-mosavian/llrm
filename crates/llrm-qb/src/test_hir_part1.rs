...
fn machine(
    ...
    contracts: &IndexMap<i64, llrm_core::abi::runtime::Contract>,
    pointer_model: Option<llrm_core::backend::pointers::Model>,
) -> lir::LirBody {
