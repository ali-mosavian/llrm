...
profiles in `docs/qrender/contracts/`; no temporary monkeypatch scripts are needed.
The recipe is in `docs/qrender/contracts/readme.md`. It preserves the audited input
...
MAIN now uses the checked-in `docs/qrender/contracts/qrender-main.json` profile via
...
`--native-fpu --contracts docs/qrender/contracts/qrender-main.json --contract-root
...
recorded in [native-fpu-waits.md](../semantics/native-fpu-waits.md): repeated load/add becomes
