...
`crates/llrm-core/src/model/memory.rs` is the one machine-independent vocabulary for memory.
...
`crates/llrm-core/src/analysis/alias.rs::points_to` propagates provenance through SSA copies,
