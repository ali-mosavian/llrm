...
The current strict rule in `docs/split.md` remains in force until the new MIR,
...
- Update `docs/split.md`, `docs/mir-vocabulary.md`, and architecture diagrams.
...
13. The final quality gate remains `docs/targets.md`; richer MIR is enabling
