...
| 5 | `qbopt/rewrite.py` | 341 | `src/rewrite.rs` | ported (BC dump) | test_array_access, test_basic_semantics, test_contract_profile, test_cpu_driver, test_lir, test_regions, test_rewrite, test_simplify, test_transform |
