...
| 2 | `qbopt/analysis/liveness.py` | 159 | `src/analysis/liveness.rs` | todo | test_regalloc, test_word_arithmetic_carry |
...
| 3 | `qbopt/analysis/flags.py` | 111 | `src/analysis/flags.rs` | todo | test_calls, test_ir, test_lift |
...
| 3 | `qbopt/analysis/frameescape.py` | 170 | `src/analysis/frameescape.rs` | todo | test_frame_escape |
