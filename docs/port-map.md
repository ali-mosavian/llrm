...
| 2 | `qbopt/backend/omfwrite.py` | 675 | `src/backend/omfwrite.rs` | ported (C path) | test_cbench_e2e, test_cfront_frontend, test_cfront_int64_e2e, test_frontend_parity, test_spiller, test_wholeseg |
