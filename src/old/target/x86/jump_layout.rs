...
mod tests {
    ...
    use crate::old::target::x86::{ConditionCode, X86FixupKind, X86Opcode, X86Register};
    ...
    fn jump(id: u32, symbol: u32) -> MCFragment {
        MCFragment::Instruction(InstructionFragment {
            id: FragmentId::new(id),
            instruction: MCInstruction {
                opcode: crate::old::mc::TargetOpcode::new(X86Opcode::Jump as u32),
    ...
    fn conditional_jump(id: u32, condition: ConditionCode, symbol: u32) -> MCFragment {
        MCFragment::Instruction(InstructionFragment {
            id: FragmentId::new(id),
            instruction: MCInstruction {
                opcode: crate::old::mc::TargetOpcode::new(X86Opcode::JumpConditional as u32),
                operands: vec![
    ...
    fn mov(id: u32) -> MCFragment {
        MCFragment::Instruction(InstructionFragment {
            id: FragmentId::new(id),
            instruction: MCInstruction {
                opcode: crate::old::mc::TargetOpcode::new(X86Opcode::Mov as u32),
                operands: vec![
                    MCOperand::Register(crate::old::mc::PhysicalRegister::new(
                        X86Register::Ax as u32,
                    )),
                    MCOperand::Register(crate::old::mc::PhysicalRegister::new(
                        X86Register::Bx as u32,
                    )),
                ],
            },
            fixups: Vec::new(),
        ...
        let source = module(
            vec![
                ...
                MCFragment::Instruction(InstructionFragment {
                    id: FragmentId::new(2),
                    instruction: MCInstruction {
                        opcode: crate::old::mc::TargetOpcode::new(X86Opcode::CallFar as u32),
                        operands: vec![MCOperand::Expression(MCExpression {
