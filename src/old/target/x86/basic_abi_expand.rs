...
mod tests {
    ...
    use crate::old::target::x86::{encode, expand_allocated_word_merges, lower_instruction};
    ...
    fn refuses_bad_abi_boundary_facts() {
        ...
        constrained.constraint = Some(crate::old::codegen::machine::RegisterConstraint::Fixed(
        ...
        tied.tied_to = Some(crate::old::codegen::machine::OperandIndex::new(1));
