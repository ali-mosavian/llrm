...
fn starts_expanded(
    block: &crate::old::codegen::machine::MachineBlock,
    saved: &[X86Register],
) -> bool {
...
mod tests {
    use super::*;
    use crate::old::codegen::machine::{
        FrameObject, MachineBlock, MachineLinkage, MachineSignature,
    };
    ...
    fn incoming(index: u32, parameter: u32) -> crate::old::codegen::machine::FrameObject {
        FrameObject {
    ...
    fn local(index: u32, size: u32) -> crate::old::codegen::machine::FrameObject {
        FrameObject {
            index: FrameIndex::new(index),
            size,
            alignment: 2,
