...
pub enum SelectionError {
    ...
    UnknownGlobal {
        function: FunctionId,
        block: BlockId,
        instruction: crate::old::ir::InstructionId,
        global: GlobalId,
    },
...
fn select_data_relocation(
    global: GlobalId,
    relocation: &crate::old::ir::GlobalRelocation,
    globals: &BTreeMap<GlobalId, &Global>,
    ...
    fn select_c_return(
        ...
        if matches!(result_kind, TypeKind::Float(_)) {
            ...
            let selected = self.select_operand(
                block.id,
                crate::old::ir::InstructionId::new(0),
                value,
                result_type,
                output,
            )?;
...
mod tests {
    use super::*;
    use crate::old::codegen::machine::MachineRegister;
    use crate::old::ir::{CallingConvention, FloatKind, Signature, Type};
    ...
    fn signature(result: TypeId, parameters: Vec<TypeId>) -> crate::old::ir::Signature {
        Signature {
            result,
            parameters,
            variadic: false,
    ...
    fn function(blocks: Vec<Block>, parameters: Vec<Value>) -> Function {
        Function {
            ...
            linkage: crate::old::ir::Linkage::Internal,
            attributes: Vec::new(),
            parameters,
            blocks,
        }
                    ...
                    vec![function(
                        vec![Block {
                            ...
                            instructions: vec![Instruction {
                                id: crate::old::ir::InstructionId::new(0),
                                results: vec![result],
    ...
    fn far_memory_module(address_space: AddressSpace, store: bool) -> Module {
        ...
        if store {
            instructions.push(Instruction {
                id: crate::old::ir::InstructionId::new(1),
                results: Vec::new(),
    ...
    fn far_memory_selects_word_load_through_occurrence_local_es() {
        ...
        crate::old::target::x86::verify_machine(&selected)
            .expect("far word load Machine IR verifies");
        let function = &selected.functions[0];
        let instructions = &function.blocks[0].instructions;
    ...
    fn far_memory_selects_word_store_after_materializing_source() {
        ...
        crate::old::target::x86::verify_machine(&selected)
            .expect("far word store Machine IR verifies");
        let function = &selected.functions[0];
        let instructions = &function.blocks[0].instructions;
        ...
        let function = function(
            vec![Block {
                ...
                instructions: vec![
                    ...
                    Instruction {
                        id: crate::old::ir::InstructionId::new(2),
                    ...
                    Instruction {
                        id: crate::old::ir::InstructionId::new(3),
                    ...
                    Instruction {
                        id: crate::old::ir::InstructionId::new(4),
    ...
    fn refuses_relocatable_data_with_an_unknown_target() {
        let source = data_global(
            ...
            Constant::RelocatableBytes {
                bytes: vec![0, 0],
                relocations: vec![crate::old::ir::GlobalRelocation {
                    offset: 0,
    ...
    fn runtime_declaration(id: FunctionId, name: &str, parameters: Vec<TypeId>) -> Function {
        Function {
            id,
            name: name.to_owned(),
            signature: crate::old::ir::Signature {
                result: VOID,
    ...
    fn selects_external_c_float_calls_as_python_invoke_and_push() {
        ...
        let stackified = crate::old::target::x86::allocate_x87_stack(&selected.functions[0])
