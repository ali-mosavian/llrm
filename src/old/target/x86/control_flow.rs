...
fn jump(id: MachineInstructionId, target: MachineBlockId) -> MachineInstruction {
    MachineInstruction {
        ...
        flags: crate::old::codegen::machine::InstructionFlags {
            terminator: true,
            ..crate::old::codegen::machine::InstructionFlags::NONE
        },
    }
}
...
fn block_operand(block: MachineBlockId) -> crate::old::codegen::machine::MachineOperand {
    crate::old::codegen::machine::MachineOperand {
        kind: MachineOperandKind::Block(block),
        role: crate::old::codegen::machine::OperandRole::None,
        constraint: None,
        tied_to: None,
    }
}
...
mod tests {
    ...
    fn instruction(
        id: u32,
        opcode: X86Opcode,
        operands: Vec<crate::old::codegen::machine::MachineOperand>,
    ) -> MachineInstruction {
        MachineInstruction {
