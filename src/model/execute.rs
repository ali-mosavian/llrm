...
pub(crate) struct ExecutionError(pub String);
...
pub(crate) type Memory = IndexMap<(Segment, i64), u8>;
...
pub(crate) type Call<'a> = dyn FnMut(&Op, &[BigInt]) -> Result<Vec<BigInt>, ExecutionError> + 'a;
