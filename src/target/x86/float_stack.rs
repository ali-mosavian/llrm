...
pub enum X86FloatAllocationError {
    InvalidMachineIr {
        function: crate::codegen::machine::MachineFunctionId,
...
struct FunctionState {
    id: crate::codegen::machine::MachineFunctionId,
    x87: BTreeSet<VirtualRegisterId>,
    register_widths: BTreeMap<VirtualRegisterId, u32>,
...
fn memory_arithmetic_opcode(
    ...
    Ok(match opcode {
        ...
        _ => {
            return Err(X86FloatAllocationError::MalformedInstruction {
                function: crate::codegen::machine::MachineFunctionId::new(0),
...
mod tests {
    ...
    fn keeps_a_pure_x87_call_result_in_the_post_call_region() {
        ...
        result.constraint = Some(crate::codegen::machine::RegisterConstraint::Fixed(
