...
pub(crate) fn _descriptor_values(
...
pub(crate) fn _addresses(body: RaisedBody, symbols: &IndexMap<Value, Symbol>) -> RaisedBody {
...
pub(crate) fn _shape(arguments: &[Option<Arg>]) -> Option<(Symbol, i64, i64, i64)> {
...
pub(crate) fn _request(arguments: &[Option<Arg>], replaces: bool) -> Option<ArrayRequest> {
