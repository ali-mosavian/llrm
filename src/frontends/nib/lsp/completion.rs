//! `textDocument/completion`: keywords and the module's own names; after
...
use super::resolve::declaring;
use super::text;
use crate::frontends::nib::lexer::KEYWORDS;
use crate::frontends::nib::semantic::Known;
use crate::frontends::nib::{check, module_path};

const KEYWORD: u8 = 14;
const MODULE: u8 = 9;
/// A name put where a member is being typed, so that the text checks as far as it.
