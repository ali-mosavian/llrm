...
use crate::object::omf::module::{Addr, Space, far_pointer, frame_relative, literal_only};
...
mod tests {
    ...
    use crate::frontend::omf::declen::{Insn, decode};
    use crate::object::omf::module::{Addr, Space, far_pointer, literal_only};
    use crate::target::x86::X86Register;
    ...
    fn omf_lift_classify_operand_refuses_a_group_relative_address() {
        ...
        let group_only = |_field_offset: usize, literal: u64| Addr {
            ...
            disp: literal as i64,
            index: 1,
            base: crate::object::omf::module::NO_REGISTER,
            segment: crate::object::omf::module::NO_REGISTER,
        };
