...
use crate::codegen::machine::{Effects, RESTORE_IDIOM, Semantics, TABLE_DATA, UNMODELLED, barrier};
use crate::support::PhysicalRegister;
use crate::target::x86::X86Register;

use super::declen::Insn;
use super::lift::Decoded;
...
fn restore_effects(low: X86Register, high: X86Register) -> Effects {
    ...
    Effects {
        ...
        uses: Some(registers),
        flags_written: crate::codegen::machine::Flag::NONE,
        flags_read: crate::codegen::machine::Flag::NONE,
        loads: Vec::new(),
        stores: Vec::new(),
        fp_stack: false,
...
mod tests {
    ...
    use crate::codegen::machine::{Effects, RESTORE_IDIOM, TABLE_DATA, UNMODELLED, barrier};
    use crate::frontend::omf::declen::decode;
    use crate::frontend::omf::lift::{Decoded, Kind};
    use crate::target::x86::X86Register;

    fn insn(at: usize) -> crate::frontend::omf::declen::Insn {
