...
//! [`crate::frontend::qb::syntax::Statement`].

use crate::frontend::qb::generated_parser::tables::{
    DIALECT_EXTENSIONS, ExtensionPatternToken, ExtensionTail, GeneratedExtensionAction,
};
use crate::frontend::qb::generated_parser::{Token, TokenKind};
...
/// dialect mask; the selected [`crate::frontend::qb::Dialect`] matters after parsing.
...
fn ends_statement(token: Option<&Token>) -> bool {
    ...
    let newline = crate::frontend::qb::generated_parser::tables::token_id("tkNewLine")
        .expect("recovered grammar has tkNewLine");
    let colon = crate::frontend::qb::generated_parser::tables::token_id("tkColon")
...
mod tests {
    use super::*;
    use crate::frontend::qb::Dialect;
    use crate::frontend::qb::generated_parser::lex;
