...
use crate::frontend::qb::intrinsics::{self, Lowering, ResultClass};
...
impl Compiler {
    ...
    fn variable(&mut self, name: &str) -> Result<Variable, SemanticError> {
        ...
        let declaration = Declaration {
            ...
            shared: false,
            dynamic: false,
            span: crate::frontend::qb::syntax::Span {
                line: 0,
                start: 0,
                end: 0,
            },
    ...
    fn string_literal_places(&mut self, text: &str) -> Result<(u32, u32, u32), SemanticError> {
        let encoded =
            crate::frontend::qb::source::encode_cp437(text).ok_or_else(|| SemanticError {
